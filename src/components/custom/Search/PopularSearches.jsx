...
const PopularSearches = () => {
    ...
    if(isLoading){
        ...
        content = topSearches.slice(0, 10).map(item => (
            <div key={item.term} className="flex items-center justify-between gap-2 bg-white dark:bg-gray-800 p-2 rounded-md my-1 hover:bg-white/60 dark:hover:bg-gray-900 transition duration-300">
                <h1>"{item.term}"</h1>
  ...
  return (
    <div className="bg-gray-200 dark:bg-gray-700 w-full p-2 rounded-md md:w-1/2 h-full">
                ...
                <h1 className="text-xl flex dark:text-gray-300 text-gray-700 font-bold items-center gap-2 mb-2">10 Most Popular Searches</h1>
