  ...
  return (
    <DrawerRoot placement="start" open={open} onOpenChange={(e) => setOpen(e.open)}>
      ...
      <DrawerContent>
        <DrawerHeader>
            <FlexColumn>
                <Image width={100} height={75} alt="Tentlify Rentals" src="https://firebasestorage.googleapis.com/v0/b/mern-ecommerce-f07b1.appspot.com/o/Tenlify_Logo_Thin_Small.png?alt=media&token=59587449-7b7c-439f-a434-5b4059035b11" className="w-[150px]" />
            </FlexColumn>
        </DrawerHeader>
        <DrawerBody>
            <FlexColumn>
          ...
          <div className="bg-black/30 inset-0 absolute z-20 top-0 left-0 w-full"></div>
        <Image width={300} height={200} alt="Location" src="https://firebasestorage.googleapis.com/v0/b/mern-ecommerce-f07b1.appspot.com/o/Screenshot%202024-09-18%20at%205.35.50%E2%80%AFPM.png?alt=media&token=fa1d7420-d9e9-4189-9597-015c43fc5159" className="w-full h-[100px] object-cover z-10 rounded-md" />
        ...
        <div className="bg-black/30 inset-0 absolute z-20 top-0 left-0 w-full"></div>
        <Image width={300} height={200} alt="Gallery" src="https://firebasestorage.googleapis.com/v0/b/mern-ecommerce-f07b1.appspot.com/o/View%20recent%20photos.jpg?alt=media&token=ad5e25d9-63f9-43fb-8539-4c2a92004bd0" className="w-full h-[100px] object-cover z-10 rounded-md" />
